//  
//  Generated include file (by Visual Kosmos Compiler)
//  Typelib parsed:e:\office\office\excel9.olb
//  
...
//----------------------- Constants XlDisplayBlanksAs Enum----------------------
*define  xlInterpolated = 3
*define  xlNotPlotted = 1
*define  xlZero = 2
//----------------------- Constants XlArrowHeadStyle Enum----------------------
...
//----------------------- Constants XlTickLabelPosition Enum----------------------
...
//----------------------- Constants XlLegendPosition Enum----------------------
...
//----------------------- Constants XlChartPictureType Enum----------------------
*define  xlStackScale = 3
*define  xlStack = 2
*define  xlStretch = 1
//----------------------- Constants XlChartPicturePlacement Enum----------------------
*define  xlSides = 1
*define  xlEnd = 2
*define  xlEndSides = 3
*define  xlFront = 4
...
//----------------------- Constants XlBorderWeight Enum----------------------
*define  xlHairline = 1
*define  xlMedium = -4138
*define  xlThick = 4
*define  xlThin = 2
//----------------------- Constants XlDataSeriesDate Enum----------------------
*define  xlDay = 1
*define  xlMonth = 3
*define  xlWeekday = 2
*define  xlYear = 4
//----------------------- Constants XlUnderlineStyle Enum----------------------
...
//----------------------- Constants XlTrendlineType Enum----------------------
...
//----------------------- Constants XlDataLabelsType Enum----------------------
...
//----------------------- Constants XlPictureConvertorType Enum----------------------
*define  xlBMP = 1
*define  xlCGM = 7
*define  xlDRW = 4
*define  xlDXF = 5
...
//----------------------- Constants XlDataLabelPosition Enum----------------------
...
//----------------------- Constants XlTimeUnit Enum----------------------
*define  xlDays = 0
*define  xlMonths = 1
*define  xlYears = 2
//----------------------- Constants XlCategoryType Enum----------------------
*define  xlCategoryScale = 2
*define  xlTimeScale = 3
*define  xlAutomaticScale = -4105
//----------------------- Constants XlBarShape Enum----------------------
*define  xlBox = 0
...
//----------------------- Constants XlFindLookIn Enum----------------------
*define  xlFormulas = -4123
*define  xlComments = -4144
*define  xlValues = -4163
//----------------------- Constants XlWindowType Enum----------------------
*define  xlChartAsWindow = 5
*define  xlChartInPlace = 4
*define  xlClipboard = 3
*define  xlInfo = -4129
*define  xlWorkbook = 1
//----------------------- Constants XlPivotFieldDataType Enum----------------------
*define  xlDate = 2
*define  xlNumber = -4145
*define  xlText = -4158
//----------------------- Constants XlCopyPictureFormat Enum----------------------
*define  xlBitmap = 2
*define  xlPicture = -4147
//----------------------- Constants XlPivotTableSourceType Enum----------------------
*define  xlConsolidation = 3
*define  xlDatabase = 1
*define  xlExternal = 2
*define  xlPivotTable = -4148
//----------------------- Constants XlReferenceStyle Enum----------------------
*define  xlA1 = 1
*define  xlR1C1 = -4150
//----------------------- Constants XlMSApplication Enum----------------------
...
//----------------------- Constants XlEditionFormat Enum----------------------
*define  xlBIFF = 2
*define  xlPICT = 1
*define  xlRTF = 4
*define  xlVALU = 8
//----------------------- Constants XlLink Enum----------------------
*define  xlExcelLinks = 1
*define  xlOLELinks = 2
*define  xlPublishers = 5
*define  xlSubscribers = 6
//----------------------- Constants XlCellType Enum----------------------
...
//----------------------- Constants XlMousePointer Enum----------------------
*define  xlIBeam = 3
*define  xlDefault = -4143
*define  xlNorthwestArrow = 1
*define  xlWait = 2
//----------------------- Constants XlEditionOptionsOption Enum----------------------
...
//----------------------- Constants XlAutoFilterOperator Enum----------------------
*define  xlAnd = 1
...
//----------------------- Constants XlClipboardFormat Enum----------------------
...
*define  xlHtml = 44
//----------------------- Constants XlApplicationInternational Enum----------------------
...
//----------------------- Constants XlPasteSpecialOperation Enum----------------------
...
//----------------------- Constants XlPhoneticCharacterType Enum----------------------
*define  xlKatakanaHalf = 0
*define  xlKatakana = 1
*define  xlHiragana = 2
*define  xlNoConversion = 3
//----------------------- Constants XlPhoneticAlignment Enum----------------------
...
//----------------------- Constants XlPictureAppearance Enum----------------------
*define  xlPrinter = 2
*define  xlScreen = 1
//----------------------- Constants XlPivotFieldOrientation Enum----------------------
*define  xlColumnField = 2
*define  xlDataField = 4
*define  xlHidden = 0
*define  xlPageField = 3
*define  xlRowField = 1
//----------------------- Constants XlPivotFieldCalculation Enum----------------------
...
//----------------------- Constants XlRangeAutoFormat Enum----------------------
...
*define  xlEdgeTop = 8
//----------------------- Constants XlToolbarProtection Enum----------------------
...
//----------------------- Constants XlBuiltInDialog Enum----------------------
...
*define X_xlDialogPhonetic = 538
*define  xlDialogChartSourceData = 540
*define X_xlDialogChartSourceData = 541
...
//----------------------- Constants XlParameterType Enum----------------------
*define  xlPrompt = 0
*define  xlConstant = 1
*define  xlRange = 2
//----------------------- Constants XlParameterDataType Enum----------------------
...
//----------------------- Constants XlHtmlType Enum----------------------
*define  xlHtmlStatic = 0
*define  xlHtmlCalc = 1
*define  xlHtmlList = 2
*define  xlHtmlChart = 3
//----------------------- Constants xlPivotFormatType Enum----------------------
*define  xlReport1 = 0
*define  xlReport2 = 1
*define  xlReport3 = 2
*define  xlReport4 = 3
...
*define  xlPTNone = 21
//----------------------- Constants XlCmdType Enum----------------------
*define  xlCmdCube = 1
*define  xlCmdSql = 2
*define  xlCmdTable = 3
*define  xlCmdDefault = 4
//----------------------- Constants xlColumnDataType Enum----------------------
...
//----------------------- Constants xlWebSelectionType Enum----------------------
*define  xlEntirePage = 1
*define  xlAllTables = 2
*define  xlSpecifiedTables = 3
//----------------------- Constants XlCubeFieldType Enum----------------------
*define  xlHierarchy = 1
*define  xlMeasure = 2
//----------------------- Constants xlWebFormatting Enum----------------------
*define  xlWebFormattingAll = 1
*define  xlWebFormattingRTF = 2
*define  xlWebFormattingNone = 3
//----------------------- Constants xlDisplayDrawingObjects Enum----------------------
*define  xlDisplayShapes = -4104
*define  xlHide = 3
*define  xlPlaceholders = 2
//----------------------- Constants xLSubtototalLocationType Enum----------------------
*define  xlAtTop = 1
*define  xlAtBottom = 2
//----------------------- Event RefreshEvents Interface----------------------
*define RefreshEvents="{0002441B-0000-0000-C000-000000000046}"
//----------------------- MEMBERS ----------------------
*define BeforeRefresh=1596
*define AfterRefresh=1597
//----------------------- Event AppEvents Interface----------------------
*define AppEvents="{00024413-0000-0000-C000-000000000046}"
//----------------------- MEMBERS ----------------------
*define NewWorkbook=1565
*define SheetSelectionChange=1558
*define SheetBeforeDoubleClick=1559
*define SheetBeforeRightClick=1560
*define SheetActivate=1561
*define SheetDeactivate=1562
*define SheetCalculate=1563
*define SheetChange=1564
*define WorkbookOpen=1567
*define WorkbookActivate=1568
*define WorkbookDeactivate=1569
*define WorkbookBeforeClose=1570
*define WorkbookBeforeSave=1571
*define WorkbookBeforePrint=1572
*define WorkbookNewSheet=1573
*define WorkbookAddinInstall=1574
*define WorkbookAddinUninstall=1575
*define WindowResize=1554
*define WindowActivate=1556
*define WindowDeactivate=1557
*define SheetFollowHyperlink=1854
//----------------------- Event ChartEvents Interface----------------------
*define ChartEvents="{0002440F-0000-0000-C000-000000000046}"
//----------------------- MEMBERS ----------------------
*define Activate=304
*define Deactivate=1530
*define Resize=256
*define MouseDown=1531
*define MouseUp=1532
*define MouseMove=1533
*define BeforeRightClick=1534
*define DragPlot=1535
*define DragOver=1536
*define BeforeDoubleClick=1537
*define Select=235
*define SeriesChange=1538
*define Calculate=279
//----------------------- Event DocEvents Interface----------------------
*define DocEvents="{00024411-0000-0000-C000-000000000046}"
//----------------------- MEMBERS ----------------------
*define SelectionChange=1543
*define BeforeDoubleClick=1537
*define BeforeRightClick=1534
*define Activate=304
*define Deactivate=1530
*define Calculate=279
*define Change=1545
*define FollowHyperlink=1470
//----------------------- Event WorkbookEvents Interface----------------------
*define WorkbookEvents="{00024412-0000-0000-C000-000000000046}"
//----------------------- MEMBERS ----------------------
*define Open=682
*define Activate=304
*define Deactivate=1530
*define BeforeClose=1546
*define BeforeSave=1547
*define BeforePrint=1549
*define NewSheet=1550
*define AddinInstall=1552
*define AddinUninstall=1553
*define WindowResize=1554
*define WindowActivate=1556
*define WindowDeactivate=1557
*define SheetSelectionChange=1558
...
*define SheetChange=1564
*define SheetFollowHyperlink=1854
//----------------------- Event OLEObjectEvents Interface----------------------
*define OLEObjectEvents="{00024410-0000-0000-C000-000000000046}"
//----------------------- MEMBERS ----------------------
*define GotFocus=1541
*define LostFocus=1542
